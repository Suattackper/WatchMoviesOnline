...
public final class ActivityEditProfileAccountBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final CircleImageView editImvUserAvatar;
  ...
  private ActivityEditProfileAccountBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatButton btnSave, @NonNull TextInputEditText editEmail,
      @NonNull CircleImageView editImvUserAvatar, @NonNull TextInputEditText editPhone,
      @NonNull TextInputEditText editUserName, @NonNull Guideline guideline1,
      @NonNull Guideline guideline2, @NonNull ImageView imvBack,
      ...
      @NonNull Toolbar toolbarEditProfile) {
    this.rootView = rootView;
    this.btnSave = btnSave;
    this.editEmail = editEmail;
    this.editImvUserAvatar = editImvUserAvatar;
  ...
  @NonNull
  public static ActivityEditProfileAccountBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEditProfileAccountBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_edit_profile_account, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEditProfileAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editImvUserAvatar;
      CircleImageView editImvUserAvatar = ViewBindings.findChildViewById(rootView, id);
      if (editImvUserAvatar == null) {
        break missingId;
      }
      ...
      return new ActivityEditProfileAccountBinding((ConstraintLayout) rootView, btnSave, editEmail,
          editImvUserAvatar, editPhone, editUserName, guideline1, guideline2, imvBack,
          imvUserAvatar, lyEmail, lyPass, lyPhone, toolbarEditProfile);
    }
