...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final LottieAnimationView animLogo;

  @NonNull
  public final ConstraintLayout main;

  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView animLogo, @NonNull ConstraintLayout main) {
    this.rootView = rootView;
    this.animLogo = animLogo;
    this.main = main;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.animLogo;
      LottieAnimationView animLogo = ViewBindings.findChildViewById(rootView, id);
      if (animLogo == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, animLogo, main);
    }
